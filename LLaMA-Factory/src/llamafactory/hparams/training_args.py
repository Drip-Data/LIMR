...
from .limr_args import LIMRArguments
...
class TrainingArguments(RayArguments, Seq2SeqTrainingArguments):
    ...
    limr: LIMRArguments = field(
        default_factory=LIMRArguments,
        metadata={"help": "Arguments for LIMR (Learning Impact Measurement for Reinforcement) workflow."}
    )
