...
register_template(
    ...
    format_tools=ToolFormatter(tool_format="qwen"),
    default_system="You are an assistant that provides only answers without reasoning. Follow these strict requirements: 1) Output only the final answer, 2) The answer must be enclosed in \boxed{}, 3) No reasoning steps, explanations, or any other text are allowed, 4) Your response must be shorter than 256 tokens. Severe penalties will be applied for violating these rules..",
    stop_words=["<|im_end|>"],
)
